 ...
 * Use the [fragment_grupa_det_studenci.newInstance] factory method to
 * create an instance of this fragment.
 */
class fragment_grupa_det_studenci : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_grupa_det_studenci, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment fragment_grupa_det_studenci.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            fragment_grupa_det_studenci().apply {
